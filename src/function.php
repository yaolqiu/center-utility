...
use Lyqiu\EsNotify\DingTalk\Message\Markdown;
use Lyqiu\EsNotify\DingTalk\Message\Text;
use Lyqiu\EsNotify\EsNotify;
use Lyqiu\EsNotify\WeChat\Message\Notice;
use Lyqiu\EsNotify\WeChat\Message\Warning;
use Lyqiu\CenterUtility\Common\Classes\LamJwt;
use Lyqiu\CenterUtility\Common\Classes\Mysqli;
...
if ( ! function_exists('get_sermod')) {
    ...
    {
        $mod = config("iot_product.$serial[0].table");
